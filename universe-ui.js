(() => {
  ...
  const brandLogo=(small=false)=>`<div class="gti-brand ${small?'is-small':''}" aria-label="GTI Missions"><div><i>♛</i><b>GTI</b></div><span>MISSIONS</span></div>`;
