drop function if exists public.gti_missions_log_custom_challenge(uuid,numeric,text);
create function public.gti_missions_log_custom_challenge(
  p_challenge_id uuid,
...
grant execute on function public.gti_missions_log_custom_challenge(uuid,numeric,text,text) to authenticated;
